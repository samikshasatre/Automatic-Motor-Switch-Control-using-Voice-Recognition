...
#define WIFI_SSID         "Appi"
#define WIFI_PASS         "Appi2005"
#define APP_KEY           "e884c800-7465-49ea-a985-c298afddd986"
#define APP_SECRET        "33d7d64f-38b2-4fef-b0cf-f499de4c2626-a1a3ba03-0bb6-4946-86e7-cbd006a73714"
...
std::map<String, deviceConfig_t> devices = {
    ...
    {"687f3e8eedeca866fe933d82", {  5, 4, true }},
    {"687f40e7edeca866fe933ed3", {  14, 12, true }},
...
void setupRelays() { 
  for (auto &device : devices) {           // for each device (relay, flipSwitch combination)
    ...
    digitalWrite(relayPIN, HIGH);            // set relay pin to OUTPUT
  }
}
